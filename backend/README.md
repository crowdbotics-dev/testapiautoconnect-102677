...
## Project Structure
    ...
    ├── testapiautoconnect_102677  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_102677`
...
2. Clone this repo and `cd testapiautoconnect_102677`
